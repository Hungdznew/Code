...
bot = telebot.TeleBot("6249479776:AAFEZPnOa-vTim51uNF9XsaasVZBVaukj_I")
...
def game(message):
    ...
    if message.text == "1":
        ...
        bot.reply_to(message, "HUY CODER LỎ\n\n@ : ZALO : 0853805819")
    elif message.text == "7":
